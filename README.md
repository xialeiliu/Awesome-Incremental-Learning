...
- <a name="todo"></a> Optimizing Reusable Knowledge for Continual Learning via Metalearning (**NeurIPS2021**) [[paper](https://arxiv.org/abs/2106.05390)]
- <a name="todo"></a> Formalizing the Generalization-Forgetting Trade-off in Continual Learning (**NeurIPS2021**) [[paper](https://arxiv.org/abs/2109.14035)]
...
- <a name="todo"></a> Flattening Sharpness for Dynamic Gradient Projection Memory Benefits Continual Learning (**NeurIPS2021**) [[paper](https://arxiv.org/abs/2110.04593)]
- <a name="todo"></a> Posterior Meta-Replay for Continual Learning (**NeurIPS2021**) [[paper](https://arxiv.org/abs/2103.01133)]
- <a name="todo"></a> Continual Auxiliary Task Learning (**NeurIPS2021**) [[paper](https://nips.cc/Conferences/2021/AcceptedPapersInitial)]
- <a name="todo"></a> Mitigating Forgetting in Online Continual Learning with Neuron Calibration (**NeurIPS2021**) [[paper](https://nips.cc/Conferences/2021/AcceptedPapersInitial)]
- <a name="todo"></a> BNS: Building Network Structures Dynamically for Continual Learning (**NeurIPS2021**) [[paper](https://nips.cc/Conferences/2021/AcceptedPapersInitial)]
- <a name="todo"></a> DualNet: Continual Learning, Fast and Slow (**NeurIPS2021**) [[paper](https://arxiv.org/abs/2110.00175)]
- <a name="todo"></a> BooVAE: Boosting Approach for Continual Learning of VAE (**NeurIPS2021**) [[paper](https://arxiv.org/abs/1908.11853)]
- <a name="todo"></a> Generative vs. Discriminative: Rethinking The Meta-Continual Learning (**NeurIPS2021**) [[paper](https://nips.cc/Conferences/2021/ScheduleMultitrack?event=26659)]
- <a name="todo"></a> Achieving Forgetting Prevention and Knowledge Transfer in Continual Learning (**NeurIPS2021**) [[paper](https://nips.cc/Conferences/2021/AcceptedPapersInitial)]
