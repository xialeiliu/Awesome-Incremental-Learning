...
- <a name="todo"></a> Canonical Shape Projection is All You Need for 3D Few-shot Class Incremental Learning (**ECCV24**)[[paper]()]
...
- <a name="todo"></a> CLOSER: Towards Better Representation Learning for Few-Shot Class-Incremental Learning (**ECCV24**)[[paper]()]
- <a name="todo"></a> On the Approximation Risk of Few-Shot Class-Incremental Learning (**ECCV24**)[[paper]()]
- <a name="todo"></a> Adapt without Forgetting: Distill Proximity from Dual Teachers in Vision-Language Models (**ECCV24**)[[paper]()]
- <a name="todo"></a> Information Bottleneck Based Data Correction in Continual  Learning (**ECCV24**)[[paper]()]
- <a name="todo"></a> Continual Learning and Unknown Object Discovery in 3D Scenes via Self-Distillation (**ECCV24**)[[paper]()]
- <a name="todo"></a> Pick-a-back: Selective Device-to-Device Knowledge Transfer in Federated Continual Learning (**ECCV24**)[[paper]()]
...
- <a name="todo"></a> CLIFF: Continual Latent Diffusion for Open-Vocabulary Object Detection (**ECCV24**)[[paper]()][[code](https://github.com/CUHK-AIM-Group/CLIFF)]
- <a name="todo"></a> RCS-Prompt: Learning Prompt to Rearrange Class Space for Prompt-based Continual Learning (**ECCV24**)[[paper]()][[code](https://github.com/longrongyang/RCS-Prompt)]
